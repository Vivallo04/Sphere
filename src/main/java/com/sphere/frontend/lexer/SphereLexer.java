package com.sphere.frontend.lexer;// Generated from .\Sphere.g4 by ANTLR 4.12.0
...
public class SphereLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__25", "T__26", "BOOL", "INTEGER", "STRING", "NOT", "SEMI", "Def", 
	...
	public SphereLexer(CharStream input) {
		super(input);
